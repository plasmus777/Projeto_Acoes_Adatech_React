...
import { BiBarChartAlt2, BiChip, BiLayerPlus, BiUserPlus } from "react-icons/bi"
                    ...
                    <div className="flex justify-center space-x-6">
                        <div className="bg-gradient-to-b from-blue-600 to-blue-500 rounded-md drop-shadow p-6">
                            <div className="flex justify-center items-center space-x-4">
                                <BiBarChartAlt2 size={32} color="white" />
                        ...
                        <div className="bg-gradient-to-b from-blue-600 to-blue-500 rounded-md drop-shadow p-6 place-content-center grid grid-cols-1 gap-6">
                            {usuario != null &&
                            <div className="flex justify-center items-center space-x-4 bg-blue-700 rounded-md drop-shadow p-6 hover:bg-blue-800 hover:text-gray-200 drop-shadow">
                                <BiLayerPlus size={32} color="white" />
                                <Link to="/wallet" className="text-white text-4xl">Cadastrar Ativo</Link>
                            </div>
                            }
                            {usuario == null &&
                                <div className="flex justify-center items-center space-x-4 bg-blue-700 rounded-md drop-shadow p-6 hover:bg-blue-800 hover:text-gray-200 drop-shadow">
                                    <BiUserPlus size={32} color="white" />
                                    <Link to="/register" className="text-white text-4xl">Cadastrar Usuário</Link>
                                </div>
                            }
                        </div>
                    </div>
